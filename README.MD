...
- Error when building package qosify, [link](https://forum.openwrt.org/t/qosify-on-rt3200-possible/111277/3?u=mikeeq)
  ...
  ```bash
  aarch64-openwrt-linux-musl-gcc: command not found
...
4. SCP (copy over SSH) OpenWRT images
   ...
   curl -Ls https://github.com/mikeeq/xiaomi_ax3200_openwrt/releases/download/v20220223-master-test/openwrt-mediatek-mt7622-xiaomi_redmi-router-ax6s-squashfs-sysupgrade.bin -o sysupgrade.bin
